...
public class chessK_WActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chess_k__w);

        docId = getIntent().getStringExtra("docId");
        playerDetailRef = db.collection("PlayerDetails").document("Chess").collection(docId);
        ...
        RecyclerView recyclerView = findViewById(R.id.chess_winner);
