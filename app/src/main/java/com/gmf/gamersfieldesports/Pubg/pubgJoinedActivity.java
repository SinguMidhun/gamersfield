...
public class pubgJoinedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pubg_joined);

        //intent strings
        docId = getIntent().getStringExtra("docId");

        //collection referance
        joinedCollref = db.collection("PlayerDetails").document("Pubg").collection(docId);
        ...
        //recyclerview
        RecyclerView recyclerView = findViewById(R.id.pubg_jkw);
