...
public class ludoK_WActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ludo_k__w);

        docId = getIntent().getStringExtra("docId");
        playerDetailRef = db.collection("PlayerDetails").document("Ludo").collection(docId);
        ...
        RecyclerView recyclerView = findViewById(R.id.ludo_winner);
