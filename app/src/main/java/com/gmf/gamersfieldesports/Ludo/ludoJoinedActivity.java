...
public class ludoJoinedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ludo_joined);

        //intent string
        docId = getIntent().getStringExtra("docId");

        //collection referance
        joinedCollref = db.collection("PlayerDetails").document("Ludo").collection(docId);
        ...
        //recyclerview
        RecyclerView recyclerView = findViewById(R.id.ludo_joined);
