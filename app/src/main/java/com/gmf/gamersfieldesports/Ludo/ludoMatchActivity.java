...
public class ludoMatchActivity extends AppCompatActivity {
    ...
    private String myludotimer;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ludo_match);

        DocRefMatch = getIntent().getStringExtra("docRef");
        docId = getIntent().getStringExtra("docId");

        //document Referance
        joinedDocref = db.collection("PlayerDetails").document("Ludo").collection(docId).document(Userid);
        ...
        //referance
        matchnum = findViewById(R.id.v_lmatchnum);
        datetime = findViewById(R.id.v_ldate);
        type = findViewById(R.id.v_ltype);
        prizepool = findViewById(R.id.v_lprizepool);
        ludoplaystore = findViewById(R.id.ludoplaystore);
        ludoTImer = findViewById(R.id.ludoTimer);
        //buttons
        mjoinbtn = findViewById(R.id.l_joinbtn);
        mjoinbtn.setEnabled(false);
        mroomidbtn = findViewById(R.id.l_roomid);
        mrulesbtn = findViewById(R.id.l_rules);
        mEntriesbtn = findViewById(R.id.l_entries);
        //progress
        mprogress = findViewById(R.id.ludoProg);
        mprogress.setVisibility(View.VISIBLE);
        //timer fields
        mStartLayout = findViewById(R.id.lstartlayout);
        ...
        matchDetailsref.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    myludotimer = pdocs.get("cTimer").toString();

                    //timer
                    ludoTImer.loadData(myludotimer,"text/html","UTF-8");
                    ludoTImer.requestFocus();
                    ludoTImer.setBackgroundColor(Color.parseColor("#CECDCB"));
                    ludoTImer.getSettings().setJavaScriptEnabled(true);
                    ludoTImer .getSettings().setGeolocationEnabled(true);
                    ...
                    Toast.makeText(ludoMatchActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                    //progressBar
                    mprogress.setVisibility(View.GONE);
                    mprogress.setFocusable(true);
                }
        ...
        mjoinbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (gameusername.equals("")){
                    Toast.makeText(ludoMatchActivity.this, "Please enter your game Information", Toast.LENGTH_SHORT).show();
                    Intent gameinfointent = new Intent(ludoMatchActivity.this, GameinfoActivity.class);
        ...
        mEntriesbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ludojwk = new Intent(ludoMatchActivity.this, ludoJoinedActivity.class);
                ludojwk.putExtra("docId",docId);
                startActivity(ludojwk);
            }
        });
        ...
        mroomidbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder roomalert = new AlertDialog.Builder(ludoMatchActivity.this);
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (documentSnapshot.exists()) {
                                ...
                                mprogress.setVisibility(View.GONE);
                                mprogress.setFocusable(true);
                                Toast.makeText(ludoMatchActivity.this, "You haven't joined the match", Toast.LENGTH_SHORT).show();
                                mroomidbtn.setEnabled(true);
                            }
                        } else {
                            //progressbar
        ...
        //ludo playstore inent
        ludoplaystore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                /*
                Intent ludoplaystore = new Intent(Intent.ACTION_VIEW);
                ludoplaystore.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.ludo.king"));
                startActivity(ludoplaystore);
        ...
        mrulesbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent rulesIntent = new Intent(ludoMatchActivity.this, HelpdeskActivity.class);
    ...
    protected void onStart() {
        ...
        usergameInfo.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()){
                    DocumentSnapshot documentSnapshot = task.getResult();
                    gameusername = documentSnapshot.get("l_name").toString().trim();
                }else{
                    Toast.makeText(ludoMatchActivity.this,task.getException().toString(),Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (main_balance >= match_fee) {
                        ...
                        Toast.makeText(ludoMatchActivity.this, "Your balance is LOW, please watch videos to get coins", Toast.LENGTH_SHORT).show();
                        Intent walletintent = new Intent(ludoMatchActivity.this, WalletActivity.class);
