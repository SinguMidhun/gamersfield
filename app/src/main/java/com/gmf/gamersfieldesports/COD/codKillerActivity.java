...
public class codKillerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cod_killer);
        ...
        RecyclerView recyclerView = findViewById(R.id.cod_killer);
