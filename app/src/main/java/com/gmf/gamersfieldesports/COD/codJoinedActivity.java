...
public class codJoinedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cod_joined);

        //intent string
        docId = getIntent().getStringExtra("docId");

        //collection referance
        joinedCollref = db.collection("PlayerDetails").document("Cod").collection(docId);
        ...
        //recyclerview
        RecyclerView recyclerView = findViewById(R.id.cod_joined);
