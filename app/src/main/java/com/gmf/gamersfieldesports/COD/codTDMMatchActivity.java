...
public class codTDMMatchActivity extends AppCompatActivity {
    ...
    private String mycodtTimer;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cod_t_d_m_match);
        ...
        tmatchnum =  findViewById(R.id.v_ctmatchnum);
        tdatetime = findViewById(R.id.v_ctdate);
        tPrizepool = findViewById(R.id.v_ctprizepool);
        ttype = findViewById(R.id.v_cttype);
        tmap = findViewById(R.id.v_ctmap);
        tperkill = findViewById(R.id.v_ctkillprize);
        codtplaystore = findViewById(R.id.codtplaystore);
        codTimer = findViewById(R.id.codtTimer);
        //buttons
        mtjoinbtn = findViewById(R.id.ct_joinbtn);
        mtjoinbtn.setEnabled(false);
        mtroomidbtn = findViewById(R.id.ct_roomidbtn);
        mtrulesbtn = findViewById(R.id.ct_rulesbtn);
        mtEntriesbtn = findViewById(R.id.ct_entriesbtn);
        //progress
        mtprogress = findViewById(R.id.tdmcodProg);
        mtprogress.setVisibility(View.VISIBLE);
        //timer fields
        mStartLayout = findViewById(R.id.ctstartlayout);
        ...
        matchDetailsref.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    mycodtTimer = pdocs.get("cTimer").toString();

                    //timer
                    codTimer.loadData(mycodtTimer,"text/html","UTF-8");
                    codTimer.requestFocus();
                    codTimer.setBackgroundColor(Color.parseColor("#CECDCB"));
                    codTimer.getSettings().setJavaScriptEnabled(true);
                    codTimer.getSettings().setGeolocationEnabled(true);
                    ...
                    Toast.makeText(codTDMMatchActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mtjoinbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (gameusername.equals("") && gameuserId.equals("")){
                    Toast.makeText(codTDMMatchActivity.this, "Please enter your game Information", Toast.LENGTH_SHORT).show();
                    Intent gameinfointent = new Intent(codTDMMatchActivity.this, GameinfoActivity.class);
        ...
        mtEntriesbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent codjoinintent = new Intent(codTDMMatchActivity.this, codJoinedActivity.class);
                codjoinintent.putExtra("docId",docId);
                startActivity(codjoinintent);
            }
        });
        ...
        mtroomidbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder roomalert = new AlertDialog.Builder(codTDMMatchActivity.this);
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (documentSnapshot.exists()) {
                                ...
                                mtprogress.setVisibility(View.GONE);
                                mtprogress.setFocusable(true);
                                Toast.makeText(codTDMMatchActivity.this, "You haven't joined the match", Toast.LENGTH_SHORT).show();
                                mtroomidbtn.setEnabled(true);
                            }
                        } else {
                            //progressbar
        ...
        //cod intent
        codtplaystore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                /*
        ...
        mtrulesbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent rulesIntent = new Intent(codTDMMatchActivity.this, HelpdeskActivity.class);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()){
                    ...
                    if (tmain_balance >= tmatch_fee) {
                        ...
                        Toast.makeText(codTDMMatchActivity.this, "Your balance is LOW,please watch videos to get coins", Toast.LENGTH_SHORT).show();
                        Intent walletintent = new Intent(codTDMMatchActivity.this, WalletActivity.class);
