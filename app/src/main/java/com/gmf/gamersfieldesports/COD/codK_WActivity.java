...
public class codK_WActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cod_k__w);

        docId = getIntent().getStringExtra("docId");
        playerDetailRef = db.collection("PlayerDetails").document("Cod").collection(docId);
        ...
        RecyclerView recyclerView = findViewById(R.id.cod_winner);
