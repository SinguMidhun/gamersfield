...
public class snakeKillerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snake_killer);

        docId = getIntent().getStringExtra("docId");
        playerDetailRef = db.collection("PlayerDetails").document("Snakerivals").collection(docId);
        ...
        RecyclerView recyclerView = findViewById(R.id.snake_killer);
