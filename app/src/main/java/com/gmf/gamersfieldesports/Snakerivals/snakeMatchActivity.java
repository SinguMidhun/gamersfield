...
public class snakeMatchActivity extends AppCompatActivity {
    ...
    private TextView snakeplaystore;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snake_match);

        DocRefMatch = getIntent().getStringExtra("docRef");
        docId = getIntent().getStringExtra("docId");

        //document Referance
        joinedDocref = db.collection("PlayerDetails").document("Snakerivals").collection(docId).document(Userid);
        ...
        //referance
        matchnum = findViewById(R.id.v_smatchnum);
        datetime = findViewById(R.id.v_sdate);
        f_prize = findViewById(R.id.v_s1stprize);
        s_prize = findViewById(R.id.v_s2ndprize);
        t_prize = findViewById(R.id.v_s3rdprize);
        type = findViewById(R.id.v_stype);
        map = findViewById(R.id.v_smap);
        perkill = findViewById(R.id.v_skillprize);
        snakeplaystore = findViewById(R.id.snakeplaystore);
        //buttons
        mjoinbtn = findViewById(R.id.s_joinbtn);
        mjoinbtn.setEnabled(false);
        mroomidbtn = findViewById(R.id.s_roomid);
        mrulesbtn = findViewById(R.id.s_rules);
        mEntriesbtn = findViewById(R.id.s_entries);
        //progress
        mprogress = findViewById(R.id.snakeProg);
        mprogress.setVisibility(View.VISIBLE);
        //timer fields
        mStartLayout = findViewById(R.id.sstartlayout);
        ...
        matchDetailsref.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(snakeMatchActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                    //progressBar
                    mprogress.setVisibility(View.GONE);
                    mprogress.setFocusable(true);
                }
        ...
        mjoinbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (gameusername.equals("")){
                    Toast.makeText(snakeMatchActivity.this, "Please enter your game Information", Toast.LENGTH_SHORT).show();
                    Intent gameinfointent = new Intent(snakeMatchActivity.this, GameinfoActivity.class);
        ...
        mEntriesbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent snakejwk = new Intent(snakeMatchActivity.this, snakeJoinedActivity.class);
                snakejwk.putExtra("docId",docId);
                startActivity(snakejwk);
            }
        });
        //roomid btn
        mroomidbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder roomalert = new AlertDialog.Builder(snakeMatchActivity.this);
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (documentSnapshot.exists()) {
                                ...
                                mprogress.setVisibility(View.GONE);
                                mprogress.setFocusable(true);
                                Toast.makeText(snakeMatchActivity.this, "You haven't joined the match", Toast.LENGTH_SHORT).show();
                                mroomidbtn.setEnabled(true);
                            }
                        } else {
                            //progressbar
        ...
        //snake playstore
        snakeplaystore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                /*
                Intent snakeplaystoreintent = new Intent(Intent.ACTION_VIEW);
                snakeplaystoreintent.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.supersolid.snake"));
                startActivity(snakeplaystoreintent);
        ...
        mrulesbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent rulesIntent = new Intent(snakeMatchActivity.this, HelpdeskActivity.class);
    ...
    protected void onStart() {
        ...
        usergameInfo.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()){
                    DocumentSnapshot documentSnapshot = task.getResult();
                    gameusername = documentSnapshot.get("s_name").toString().trim();
                }else{
                    Toast.makeText(snakeMatchActivity.this,task.getException().toString(),Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (main_balance >= match_fee) {
                        ...
                        mymatches.put("BType", "Snake Rivals");
                        ...
                        Toast.makeText(snakeMatchActivity.this, "Your balance is LOW, please TOPUP", Toast.LENGTH_SHORT).show();
                        mprogress.setVisibility(View.GONE);
                        mprogress.setFocusable(true);
                    }
                } else {
