...
public class snakeENDActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snake_e_n_d);
        ...
        //referance
        ematchnum = findViewById(R.id.v_sematchnum);
        edatetime = findViewById(R.id.v_sedate);
        ef_prize = findViewById(R.id.v_se1stprize);
        es_prize = findViewById(R.id.v_se2ndprize);
        et_prize = findViewById(R.id.v_se3rdprize);
        etype = findViewById(R.id.v_setype);
        emap = findViewById(R.id.v_semap);
        eperkill = findViewById(R.id.v_sekillprize);
        mwatchbtn = findViewById(R.id.se_watchbtn);
        mwinnersbtn = findViewById(R.id.se_winners);
        mkillerbtn = findViewById(R.id.se_killers);

        //progress
        mprogress = findViewById(R.id.endsnakeProg);
        ...
        matchDetailsref.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(snakeENDActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mwinnersbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent winner = new Intent(snakeENDActivity.this, snakeK_WActivity.class);
        ...
        mkillerbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mkillerbtn = new Intent(snakeENDActivity.this, snakeKillerActivity.class);
