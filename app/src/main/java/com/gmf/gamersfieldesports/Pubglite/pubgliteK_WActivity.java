...
public class pubgliteK_WActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pubglite_k__w);
        ...
        RecyclerView recyclerView = findViewById(R.id.pubglite_winner);
