...
public class miniKillerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mini_killer);
        ...
        RecyclerView recyclerView = findViewById(R.id.mini_killer);
