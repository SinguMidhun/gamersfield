...
public class miniJoinedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mini_joined);

        //intent string
        docId = getIntent().getStringExtra("docId");

        //collection referance
        joinedCollref = db.collection("PlayerDetails").document("Minimilitia").collection(docId);
        ...
        //recyclerview
        RecyclerView recyclerView = findViewById(R.id.mini_joined);
