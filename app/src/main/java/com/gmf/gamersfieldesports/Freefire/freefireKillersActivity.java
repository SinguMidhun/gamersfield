...
public class freefireKillersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_freefire_killers);
        ...
        RecyclerView recyclerView = findViewById(R.id.freefire_killer);
