...
public class freefireJoinedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_freefire_joined);

        //intent string
        docId = getIntent().getStringExtra("docId");

        //collection referance
        joinedCollref = db.collection("PlayerDetails").document("Freefire").collection(docId);
        ...
        //recyclerview
        RecyclerView recyclerView = findViewById(R.id.freefire_joined);
