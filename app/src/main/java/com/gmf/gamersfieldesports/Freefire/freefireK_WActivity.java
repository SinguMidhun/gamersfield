...
public class freefireK_WActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_freefire_k__w);

        docId = getIntent().getStringExtra("docId");
        playerDetailRef = db.collection("PlayerDetails").document("Freefire").collection(docId);


        Query winnerquery = playerDetailRef.orderBy("winning", Query.Direction.DESCENDING).limit(10);
        ...
        RecyclerView recyclerView = findViewById(R.id.freefire_winner);
